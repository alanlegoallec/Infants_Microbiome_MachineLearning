...
if [ $analysis = "age_at_collection" ]; then
 time=$(( 3*$time ))
elif [ $analysis = "country" ] || [ $analysis = "HvsFDvsD" ]; then
  time=$(( 4*$time ))
...
if [ $algo = "gbm" ] || [ $algo = "svmPoly" ] || [ $algo = "nb" ]; then
 if [ $analysis = "age_at_collection" ] || [ $analysis = "country" ] || [ $analysis = "HvsFDvsD" ]; then
