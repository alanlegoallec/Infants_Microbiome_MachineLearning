...
metricsS_labels <- list("age_at_collection"=c("R-Squared"), "Surv"=c("Concordance Index"), "country"= c("Mean Class Accuracies", "Accuracy", "Accuracy: Finland", "Accuracy: Estonia", "Accuracy: Russia", "Accuracy: Sweden", "Cross Entropy"), "HvsFDvsD"=c("Mean Class Accuracies", "Accuracy", "Accuracy: Healthy", "Accuracy: Future Diabetic", "Accuracy: Diabetic", "Cross Entropy"))
...
preprocess_data_app <- function(data)
{
  ...
  names(data)[which(names(data) %in% c("age_at_collection", "abx_usage", "exclusive_bf", "delivery_type", "sex", "country", "seroconverted_time", "seroconverted_ever", "D_status"))] <- c("Age", "Antibiotics Usage", "Exclusively Breastfed", "Delivery Type", "Sex", "Country of Origin", "Seroconverted Sample", "Seronconverted Ever", "Diabetic Status")
  return(data)
}
